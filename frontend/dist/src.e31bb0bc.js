...
function (_Component) {
  ...
  _createClass(Generation, [{
    ...
    value: function render() {
      var generation = {
        generationId: -999,
        expiration: '12/12/2100'
      };
      return _react.default.createElement("div", null, _react.default.createElement("h4", null, "Generation : ", generation.generationId, "."), _react.default.createElement("h4", null, "Expiration : ", new Date(generation.expiration).toString()));
    }
  }]);
...
(0, _reactDom.render)(_react.default.createElement("div", null, " Dragons are coming ...", _react.default.createElement(_Generation.default, null)), document.getElementById('root'));
